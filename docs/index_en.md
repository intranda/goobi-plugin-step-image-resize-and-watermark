...
| `watermark/heightPercent` | Size specification. If 0 is specified here, the original size of the watermark is used; otherwise, it is scaled to the size of the image |
